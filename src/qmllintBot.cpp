...
int main(int argc, char *argv[])
{
    ...
    parser.addPositionalArgument("jPath", QCoreApplication::translate("main", "Absolute path to the lint json files"));
    parser.addPositionalArgument("rPath",
                                 QCoreApplication::translate("main", "Absolute path of the local github repo"));
