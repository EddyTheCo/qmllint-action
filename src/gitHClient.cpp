...
Client::Client(const QString Grepo, const quint16 pNumber, const QString Gtoken,
               QObject *parent)
    : QObject(parent), m_Grepo(Grepo), m_pNumber(pNumber), m_Gtoken(Gtoken),
      m_apiAddress("https://api.github.com"),
